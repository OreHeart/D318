    ...
    _createClass(Home, [{
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(options) {
                ...
                var showPage, pageFirstIdx, showFileFirstIdx, diskFree, profileId, devicePath, targetFile, fullPath, buffer, devicePaths, availableFiles, drivelist;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 12:
                                diskFree = _context3.sent;

                                if (diskFree === null || diskFree === undefined) diskFree = 3000;
                            ...
                            case 26:
                                ...
                                /*_ = request({
                                    uri: global.SERVER_URL + "/plate/add-usb",
                                    formData: {
                                        'USBFile': {
                                            value: buffer,
                                            options: {
                            ...
                            case 32:
                                ...
                                return drivelist.list(function (error, drives) {
                                    ...
                                    if (_this2.config.autoFetch === "true" && _this2.config.showAll === "false" && availableFiles.length === 0) {
                                        var deviceFiles = [];
                                        for (var j = 0; j < devicePaths.length; ++j) {
                                            _this2.tempPath = devicePaths[j];
                                            deviceFiles = fs.readdirSync(_this2.tempPath);
                                            deviceFiles = deviceFiles.map(_this2.completePath, _this2);
                                            deviceFiles = deviceFiles.filter(_this2.filterFile, _this2);
                                    ...
                                    _this2.current_page = showPage;
                                    _this2.page_count = Math.ceil(availableFiles.length / 4.0);
                                    _ = _this2.list(showFileFirstIdx, availableFiles);
                                ...
                                this.addListener("click_b9", function () {
                                    if (pageFirstIdx < availableFiles.length) {
                                        ...
                                        _ = _this2.changePage("confirm", {
                                            ...
                                            diskFree: diskFree.stat.DiskFree
                                        });
                                    }
                                });
