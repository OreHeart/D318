                                        ...
                                        while (1) {
                                            switch (_context.prev = _context.next) {
                                                case 0:
                                                    ...
                                                    _context.next = 4;
                                                    return _this2.nanoDLP.command("/z-axis/move/down/micron/50000");
                        ...
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 20:
                                ...
                                if (currentMm < 0) {
                                    ...
                                    currentMm = Math.floor(currentMm * 10) / 10;
                                }

                                if (!(this.isPause && log.msg.indexOf("Position set to") !== -1 && currentMm < 50)) {
                                    _context3.next = 26;
                                    break;
                                }

                                _context3.next = 25;
                                return this.nanoDLP.command("/z-axis/move/up/micron/50000");
                            ...
                            case 43:
                                _context3.next = 45;
                                return this.setText("t1", remaining_time + "/" + total_time + " min");
